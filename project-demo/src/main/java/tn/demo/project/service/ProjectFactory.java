...
class ProjectFactory {
    ...
    Project createNew(String name, String description, LocalDate estimatedEndDate, tn.demo.project.controller.TimeEstimation estimation, ContactPersonInput contactPerson){
        return Project.createNew(idService.newProjectId(), name, description, dateService.now(), estimatedEndDate, toDomain(estimation), idService.newContactPersonId(), contactPerson.name(), contactPerson.email());
    }
